        ...
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="first" name="fname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="last" name="lname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Tanger" name="address">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="tangier" name="city">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="number" id="right-label" placeholder="90060" name="pin">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
